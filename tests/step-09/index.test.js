...
test('Execute SQL Query with INNER JOIN', async () => {
    ...
    expect(result.length).toEqual(6); // Updated to reflect the actual number of results
...
test('Execute SQL Query with LEFT JOIN', async () => {
    ...
    expect(result.length).toEqual(7); // Updated to reflect the actual number of results
});
